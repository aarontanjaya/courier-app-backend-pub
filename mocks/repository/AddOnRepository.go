...
func (_m *AddOnRepository) GetAll() (*[]entity.AddOn, error) {
	ret := _m.Called()
...
func (_m *AddOnRepository) GetById(id uint) (*entity.AddOn, error) {
	ret := _m.Called(id)
...
func (_m *AddOnRepository) GetByIds(ids []uint) (*[]entity.AddOn, error) {
	ret := _m.Called(ids)
